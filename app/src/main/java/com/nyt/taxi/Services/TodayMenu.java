...
import static com.nyt.taxi.Interfaces.WorkMenuInterface.mclLandscapeOrientation;
import static com.nyt.taxi.Interfaces.WorkMenuInterface.mclNavigator;
import static com.nyt.taxi.Interfaces.WorkMenuInterface.mclNavigatorNightMode;
import static com.nyt.taxi.Interfaces.WorkMenuInterface.mclProfile;
...
import com.nyt.taxi.Activities.OrdersHistoryActivity;
import com.nyt.taxi.Activities.ProfileActivity;
import com.nyt.taxi.Activities.Today;
...
import com.nyt.taxi.Web.WebToggleCarClass;
import com.nyt.taxi.Web.WebToggleCarOption;
import com.nyt.taxi.databinding.ActivityTodayBinding;
                        ...
                        new DialogInterface() {
                            ...
                            public void dismiss() {
                                ...
                                WebRequest.create("/api/driver/order_ready", WebRequest.HttpMethod.POST, new WebRequest.HttpResponse() {
                                        ...
                                        .setParameter("lat", UText.valueOf(UPref.lastPoint().getLatitude()))
                                        .setParameter("lut", UText.valueOf(UPref.lastPoint().getLongitude()))
                                        .request();
                            }
                        });
                break;
