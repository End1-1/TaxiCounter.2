...
import com.nyt.taxi2.BuildConfig;
...
import com.nyt.taxi2.Web.WebPushIdUpdate;
                ...
                case mResponseAuthNick:
                    try {
                        ...
                        if (jo.getString("message").toLowerCase().equals("ok")) {
                            ...
                            com.nyt.taxi2.Services.WebRequest.create("/api/driver/devices", WebRequest.HttpMethod.POST, new WebRequest.HttpResponse() {
                                @Override
                            ...
                            com.nyt.taxi2.Services.WebRequest.create(jdriver.getJSONObject("driver_info")
