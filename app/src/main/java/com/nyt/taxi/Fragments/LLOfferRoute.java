...
import com.nyt.taxi.databinding.ItemOfferRouteBinding;
...
public class LLOfferRoute extends LLRoot implements View.OnClickListener {
    ...
    public LLOfferRoute(Workspace w) {
        ...
        waytTo = TCRoute.mWayTo.equals(mWorkspace.getString(R.string.WayToClient)) ? 1 : 2;
...
//                    break;
            ...
            void bindViewHolder(int index) {
                ...
                TCRoute.OneRoute or = TCRoute.mRoutes.get(index);
                bind.tvRoute.setText(String.format("%.1f %s - %.0f %s", or.mDistance, mWorkspace.getString(R.string.km), or.mDuration, mWorkspace.getString(R.string.min)));
            }
        }
