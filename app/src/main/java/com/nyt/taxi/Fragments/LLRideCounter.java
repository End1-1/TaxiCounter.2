...
import com.nyt.taxi.Web.WebPauseOrder;
...
public class LLRideCounter extends LLRoot implements
    ...
    public LLRideCounter(Workspace w) {
        ...
        timeline.setVisibility(mWorkspace.viewTimeline());
