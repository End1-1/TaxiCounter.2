...
public class CmnOrdMenu implements View.OnClickListener {
    ...
    public static void removeOrder(int id) {
        ...
        for (int i = ja.size() - 1; i > -1; i--) {
            com.nyt.taxi2.Activities.CommonOrderActivity.CommonOrder co = g.fromJson(ja.get(i).getAsJsonObject().get("order").getAsJsonObject(), com.nyt.taxi2.Activities.CommonOrderActivity.CommonOrder.class);
            if (co.order_id == id) {
                ja.remove(i);
            }
