...
public class GDriverStatus extends GObject {
    ...
    public static class Route {
        ...
        public List<com.yandex.mapkit.geometry.Point> toYandexPoints() {
            List<com.yandex.mapkit.geometry.Point> points = new ArrayList<>();
            for (Point p: this.points) {
                points.add(new com.yandex.mapkit.geometry.Point(p.lat, p.lut));
            }
            return points;
        }
    }
